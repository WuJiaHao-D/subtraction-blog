---
description: >-
  前端处理同步异常最常用的方法就是try-catch-finally进行异常捕获，但是在了解异常捕获的时候遗漏了异常捕获中retrun的“返直觉行为”。本文主要讲述这类“反直觉行为”背后的运行机制，如果对异常处理机制感兴趣的同学可以看[前端编
id: ab8ff0
title: try-catch-finally机制中return的执行时机
datetime: '2026/01/12 10:00:00'
permalink: /posts/try_catch_finally
outline: deep
category: 前端
tags:
  - 异常处理
